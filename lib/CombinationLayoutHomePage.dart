...
class CombinationLayoutHomePage extends StatefulWidget {
  CombinationLayoutHomePage({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<StatefulWidget> createState() => _CombinationLayoutState();
}

class _CombinationLayoutState extends State<CombinationLayoutHomePage>
